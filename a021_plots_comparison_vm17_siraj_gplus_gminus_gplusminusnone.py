...
#%%
ideg_gplus = np.degrees(irad_array_gplus)
ideg_gminus = np.degrees(irad_array_gminus)
ideg_gplusminusnone = np.degrees(irad_array_gplusminusnone)
aau_gplus = aau_array_gplus
aau_gminus = aau_array_gminus
aau_gplusminusnone = aau_array_gplusminusnone
e_gplus = e_array_gplus
e_gminus = e_array_gminus
e_gplusminusnone = e_array_gplusminusnone
h_gplus = np.sqrt(aau_gplus*(1-e_gplus**2))
h_gminus = np.sqrt(aau_gminus*(1-e_gminus**2))
h_gplusminusnone = np.sqrt(aau_gplusminusnone*(1-e_gplusminusnone**2))
energy_gplus = -1/(2*aau_gplus)
energy_gminus = -1/(2*aau_gminus)
energy_gplusminusnone = -1/(2*aau_gplusminusnone)
#%%
qmat_gplus = np.loadtxt('b006_2026feb12_plutinos_gplus_siraj_qmat_delta0.4_nq400_np400.csv',delimiter=',')
pmat_gplus = np.loadtxt('b006_2026feb12_plutinos_gplus_siraj_pmat_delta0.4_nq400_np400.csv',delimiter=',')
pvalmat_gplus = np.loadtxt('b006_2026feb12_plutinos_gplus_siraj_pvalmat_delta0.4_nq400_np400.csv',delimiter=',')
fig_dummy = plt.figure(figsize=(10,10))
ax_dummy = fig_dummy.add_subplot(111)
quadset = ax_dummy.contour(qmat_gplus,pmat_gplus,pvalmat_gplus,levels=[1-probmass])
plt.close()
segs = quadset.allsegs[0]
segs_array = np.array(segs)
segs_flat = np.squeeze(segs_array)
q_ellipse_gplus = segs_flat[:,0]
p_ellipse_gplus = segs_flat[:,1]
df_gplus = pd.read_csv('b006_2026feb12_plutinos_gplus_siraj.csv')
idegmean_gplus = df_gplus['ideg_siraj'][0]
Wdegmean_gplus = df_gplus['Wdeg_siraj'][0]
iradmean_gplus = np.radians(idegmean_gplus)
Wradmean_gplus = np.radians(Wdegmean_gplus)
qmean_gplus = df_gplus['q_siraj'][0]
pmean_gplus = df_gplus['p_siraj'][0]
smean_gplus = np.sqrt(1-qmean_gplus**2-pmean_gplus**2)
kappa_gplus = df_gplus['gamma_siraj'][0]
angledeg_gplus = df_gplus['angledegs_siraj'][1]

qmat_gminus = np.loadtxt('b006_2026feb12_plutinos_gminus_siraj_qmat_delta0.4_nq400_np400.csv',delimiter=',')
pmat_gminus = np.loadtxt('b006_2026feb12_plutinos_gminus_siraj_pmat_delta0.4_nq400_np400.csv',delimiter=',')
pvalmat_gminus = np.loadtxt('b006_2026feb12_plutinos_gminus_siraj_pvalmat_delta0.4_nq400_np400.csv',delimiter=',')
fig_dummy = plt.figure(figsize=(10,10))
ax_dummy = fig_dummy.add_subplot(111)
quadset = ax_dummy.contour(qmat_gminus,pmat_gminus,pvalmat_gminus,levels=[1-probmass])
plt.close()
segs = quadset.allsegs[0]
segs_array = np.array(segs)
segs_flat = np.squeeze(segs_array)
q_ellipse_gminus = segs_flat[:,0]
p_ellipse_gminus = segs_flat[:,1]
df_gminus = pd.read_csv('b006_2026feb12_plutinos_gminus_siraj.csv')
idegmean_gminus = df_gminus['ideg_siraj'][0]
Wdegmean_gminus = df_gminus['Wdeg_siraj'][0]
iradmean_gminus = np.radians(idegmean_gminus)
Wradmean_gminus = np.radians(Wdegmean_gminus)
qmean_gminus = df_gminus['q_siraj'][0]
pmean_gminus = df_gminus['p_siraj'][0]
smean_gminus = np.sqrt(1-qmean_gminus**2-pmean_gminus**2)
kappa_gminus = df_gminus['gamma_siraj'][0]
angledeg_gminus = df_gminus['angledegs_siraj'][1]

qmat_gplusminusnone = np.loadtxt('b006_2026feb12_plutinos_gplusminusnone_siraj_qmat_delta0.4_nq400_np400.csv',delimiter=',')
pmat_gplusminusnone = np.loadtxt('b006_2026feb12_plutinos_gplusminusnone_siraj_pmat_delta0.4_nq400_np400.csv',delimiter=',')
pvalmat_gplusminusnone = np.loadtxt('b006_2026feb12_plutinos_gplusminusnone_siraj_pvalmat_delta0.4_nq400_np400.csv',delimiter=',')
fig_dummy = plt.figure(figsize=(10,10))
ax_dummy = fig_dummy.add_subplot(111)
quadset = ax_dummy.contour(qmat_gplusminusnone,pmat_gplusminusnone,pvalmat_gplusminusnone,levels=[1-probmass])
plt.close()
segs = quadset.allsegs[0]
segs_array = np.array(segs)
segs_flat = np.squeeze(segs_array)
q_ellipse_gplusminusnone = segs_flat[:,0]
p_ellipse_gplusminusnone = segs_flat[:,1]
df_gplusminusnone = pd.read_csv('b006_2026feb12_plutinos_gplusminusnone_siraj.csv')
idegmean_gplusminusnone = df_gplusminusnone['ideg_siraj'][0]
Wdegmean_gplusminusnone = df_gplusminusnone['Wdeg_siraj'][0]
iradmean_gplusminusnone = np.radians(idegmean_gplusminusnone)
Wradmean_gplusminusnone = np.radians(Wdegmean_gplusminusnone)
qmean_gplusminusnone = df_gplusminusnone['q_siraj'][0]
pmean_gplusminusnone = df_gplusminusnone['p_siraj'][0]
smean_gplusminusnone = np.sqrt(1-qmean_gplusminusnone**2-pmean_gplusminusnone**2)
kappa_gplusminusnone = df_gplusminusnone['gamma_siraj'][0]
angledeg_gplusminusnone = df_gplusminusnone['angledegs_siraj'][1]
#%%
...
#%%
# probmass_gminus_wrt_gplus = probmass_siraj(aau_array_gplus,e_array_gplus,irad_array_gplus,wrad_array_gplus,Wrad_array_gplus,Mrad_array_gplus,qmean_gminus,pmean_gminus)
# probmass_gplusminusnone_wrt_gplus = probmass_siraj(aau_array_gplus,e_array_gplus,irad_array_gplus,wrad_array_gplus,Wrad_array_gplus,Mrad_array_gplus,qmean_gplusminusnone,pmean_gplusminusnone)
# probmass_invar_wrt_gplus = probmass_siraj(aau_array_gplus,e_array_gplus,irad_array_gplus,wrad_array_gplus,Wrad_array_gplus,Mrad_array_gplus,q_invar,p_invar)
# probmass_neptune_wrt_gplus = probmass_siraj(aau_array_gplus,e_array_gplus,irad_array_gplus,wrad_array_gplus,Wrad_array_gplus,Mrad_array_gplus,q_neptune,p_neptune)
# probmass_laplace_wrt_gplus = probmass_siraj(aau_array_gplus,e_array_gplus,irad_array_gplus,wrad_array_gplus,Wrad_array_gplus,Mrad_array_gplus,q_laplace,p_laplace)

# probmass_gplus_wrt_gminus = probmass_siraj(aau_array_gminus,e_array_gminus,irad_array_gminus,wrad_array_gminus,Wrad_array_gminus,Mrad_array_gminus,qmean_gplus,pmean_gplus)
# probmass_gplusminusnone_wrt_gminus = probmass_siraj(aau_array_gminus,e_array_gminus,irad_array_gminus,wrad_array_gminus,Wrad_array_gminus,Mrad_array_gminus,qmean_gplusminusnone,pmean_gplusminusnone)
# probmass_invar_wrt_gminus = probmass_siraj(aau_array_gminus,e_array_gminus,irad_array_gminus,wrad_array_gminus,Wrad_array_gminus,Mrad_array_gminus,q_invar,p_invar)
# probmass_neptune_wrt_gminus = probmass_siraj(aau_array_gminus,e_array_gminus,irad_array_gminus,wrad_array_gminus,Wrad_array_gminus,Mrad_array_gminus,q_neptune,p_neptune)
# probmass_laplace_wrt_gminus = probmass_siraj(aau_array_gminus,e_array_gminus,irad_array_gminus,wrad_array_gminus,Wrad_array_gminus,Mrad_array_gminus,q_laplace,p_laplace)

# probmass_gplus_wrt_gplusminusnone = probmass_siraj(aau_array_gplusminusnone,e_array_gplusminusnone,irad_array_gplusminusnone,wrad_array_gplusminusnone,Wrad_array_gplusminusnone,Mrad_array_gplusminusnone,qmean_gplus,pmean_gplus)
# probmass_gminus_wrt_gplusminusnone = probmass_siraj(aau_array_gplusminusnone,e_array_gplusminusnone,irad_array_gplusminusnone,wrad_array_gplusminusnone,Wrad_array_gplusminusnone,Mrad_array_gplusminusnone,qmean_gminus,pmean_gminus)
# probmass_invar_wrt_gplusminusnone = probmass_siraj(aau_array_gplusminusnone,e_array_gplusminusnone,irad_array_gplusminusnone,wrad_array_gplusminusnone,Wrad_array_gplusminusnone,Mrad_array_gplusminusnone,q_invar,p_invar)
# probmass_neptune_wrt_gplusminusnone = probmass_siraj(aau_array_gplusminusnone,e_array_gplusminusnone,irad_array_gplusminusnone,wrad_array_gplusminusnone,Wrad_array_gplusminusnone,Mrad_array_gplusminusnone,q_neptune,p_neptune)
# probmass_laplace_wrt_gplusminusnone = probmass_siraj(aau_array_gplusminusnone,e_array_gplusminusnone,irad_array_gplusminusnone,wrad_array_gplusminusnone,Wrad_array_gplusminusnone,Mrad_array_gplusminusnone,q_laplace,p_laplace)
#%%
...
njobs = 1000
nreps = 40
infile_vm17 = 'b020_d_consolidated_mean_planes_vm17_2026feb12_plutinos_gplus_njobs'+\
...
q_ellipse_vm17_gplus,p_ellipse_vm17_gplus,a0,b0,siga,sigb,rhoab,chi2val,\
    ecc,phideg,semimajoraxis,semiminoraxis = ellipse_points_2(q_vm17,p_vm17,probmass,lenth)
infile_vm17_1 = 'b020_fortran_mean_planes_vm17_2026feb12_gplus_ijob1_njobs'+str(njobs)+'_nreps'+str(nreps)+'.txt'
...
qmean_vm17_gplus = np.sin(iradmean_vm17)*np.cos(Wradmean_vm17)
pmean_vm17_gplus = np.sin(iradmean_vm17)*np.sin(Wradmean_vm17)
...
infile_vm17 = 'b020_d_consolidated_mean_planes_vm17_2026feb12_plutinos_gminus_njobs'+\
    str(njobs)+'_nreps'+str(nreps)+'.csv'
df_vm17 = pd.read_csv(infile_vm17)
n_vm17 = df_vm17.shape[0]
i_mid_deg_vm17 = np.array(df_vm17['i_mid_deg'].to_list())
...
q_vm17 = np.sin(irad_vm17)*np.cos(Wrad_vm17)
p_vm17 = np.sin(irad_vm17)*np.sin(Wrad_vm17)
q_ellipse_vm17_gminus,p_ellipse_vm17_gminus,a0,b0,siga,sigb,rhoab,chi2val,\
    ecc,phideg,semimajoraxis,semiminoraxis = ellipse_points_2(q_vm17,p_vm17,probmass,lenth)
infile_vm17_1 = 'b020_fortran_mean_planes_vm17_2026feb12_gminus_ijob1_njobs'+str(njobs)+'_nreps'+str(nreps)+'.txt'
f = open(infile_vm17_1,'r')
flines = f.readlines()
fsplit = flines[0].split()
idegmean_vm17 = float(fsplit[2])
...
iradmean_vm17 = np.radians(idegmean_vm17)
Wradmean_vm17 = np.radians(Wdegmean_vm17)
qmean_vm17_gminus = np.sin(iradmean_vm17)*np.cos(Wradmean_vm17)
pmean_vm17_gminus = np.sin(iradmean_vm17)*np.sin(Wradmean_vm17)
# smean_vm17 = np.cos(iradmean_vm17)
# angledeg_vm17 = np.degrees(np.arcsin(np.sqrt(semimajoraxis*semiminoraxis)))
# A_vm17,qrel_vm17,prel_vm17,srel_vm17,ireldeg_vm17,Wreldeg_vm17 = shift_to_pole(q_array,p_array,s_array,idegmean_vm17,Wdegmean_vm17)

infile_vm17 = 'b020_d_consolidated_mean_planes_vm17_2026feb12_plutinos_gplusminusnone_njobs'+\
    str(njobs)+'_nreps'+str(nreps)+'.csv'
df_vm17 = pd.read_csv(infile_vm17)
n_vm17 = df_vm17.shape[0]
i_mid_deg_vm17 = np.array(df_vm17['i_mid_deg'].to_list())
...
q_vm17 = np.sin(irad_vm17)*np.cos(Wrad_vm17)
p_vm17 = np.sin(irad_vm17)*np.sin(Wrad_vm17)
q_ellipse_vm17_gplusminusnone,p_ellipse_vm17_gplusminusnone,a0,b0,siga,sigb,rhoab,chi2val,\
    ecc,phideg,semimajoraxis,semiminoraxis = ellipse_points_2(q_vm17,p_vm17,probmass,lenth)
infile_vm17_1 = 'b020_fortran_mean_planes_vm17_2026feb12_gplusminusnone_ijob1_njobs'+str(njobs)+'_nreps'+str(nreps)+'.txt'
f = open(infile_vm17_1,'r')
flines = f.readlines()
fsplit = flines[0].split()
idegmean_vm17 = float(fsplit[2])
...
iradmean_vm17 = np.radians(idegmean_vm17)
Wradmean_vm17 = np.radians(Wdegmean_vm17)
qmean_vm17_gplusminusnone = np.sin(iradmean_vm17)*np.cos(Wradmean_vm17)
pmean_vm17_gplusminusnone = np.sin(iradmean_vm17)*np.sin(Wradmean_vm17)
# smean_vm17 = np.cos(iradmean_vm17)
# angledeg_vm17 = np.degrees(np.arcsin(np.sqrt(semimajoraxis*semiminoraxis)))
# A_vm17,qrel_vm17,prel_vm17,srel_vm17,ireldeg_vm17,Wreldeg_vm17 = shift_to_pole(q_array,p_array,s_array,idegmean_vm17,Wdegmean_vm17)
#%%
...
ax.plot(q_ellipse_vm17_gplus,p_ellipse_vm17_gplus,color='teal',linestyle='dashed',linewidth=0.5)
ax.plot(q_ellipse_vm17_gminus,p_ellipse_vm17_gminus,color='tomato',linestyle='dotted',linewidth=0.5)
ax.plot(q_ellipse_vm17_gplusminusnone,p_ellipse_vm17_gplusminusnone,color=vm17color,linestyle='solid',linewidth=0.5)
ax.plot(q_ellipse_gplus,p_ellipse_gplus,color='forestgreen',linestyle='dashed',linewidth=0.5)
ax.plot(q_ellipse_gminus,p_ellipse_gminus,color='goldenrod',linestyle='dotted',linewidth=0.5)
ax.plot(q_ellipse_gplusminusnone,p_ellipse_gplusminusnone,color='black',linestyle='solid',linewidth=0.5)
...
ax.scatter(qmean_vm17_gplus,pmean_vm17_gplus,color='teal',s=s,marker='>')
ax.scatter(qmean_vm17_gminus,pmean_vm17_gminus,color='tomato',s=s,marker='v')
ax.scatter(qmean_vm17_gplusminusnone,pmean_vm17_gplusminusnone,color=vm17color,s=s,marker='*')
...
xmin_ellipse_plot = -0.24
xmax_ellipse_plot = +0.24
ymin_ellipse_plot = -0.17
ymax_ellipse_plot = +0.27
...
plt.savefig('b021_a_siraj_vm17_ellipses_'+str(probmass)+'_dots_onepanel_observed.pdf',dpi=300,bbox_inches='tight',pad_inches=0)
plt.show()
#%%
# plt.rcParams['font.size'] = 8
# s = 10
...
# ax.scatter(q_neptune,p_neptune,color='blue',s=s,marker='o') # orbit pole of neptune
# ax.scatter(q_laplace,p_laplace,color='magenta',s=s,marker='+') # laplace pole at nominal resonance
# ax.scatter(q_array_gplus,p_array_gplus,color='forestgreen',s=0.2,marker='+')
# ax.scatter(q_array_gminus,p_array_gminus,color='goldenrod',s=0.2,marker='v')
# ax.scatter(q_array_gplusminusnone,p_array_gplusminusnone,color='black',s=0.2,marker='.')
# ax.set_xlabel('$q=sin(i)cos(\Omega)$')
# ax.set_ylabel('$p=sin(i)sin(\Omega)$',labelpad=-5)
# ax.text(0.95,0.95,str(probmass*100)+'%',ha='right',va='top',bbox=dict(boxstyle='round,pad=0.2',facecolor='white',linewidth=0.5),\
#         transform=ax.transAxes)
...
# plt.tight_layout(pad=0.8,w_pad=+0.5,h_pad=0)
# plt.savefig('b009_a_plots_ellipses_'+str(probmass)+'_dots_onepanel_observed.pdf',dpi=300,bbox_inches='tight',pad_inches=0)
# plt.show()
#%%
...
# ax.text(0.92,0.92,'Observed, g+\n$\gamma_{est}=$'+str(np.round(kappa,1)),\
...
# plt.savefig('b009_2026feb17figure7_observed_subplots1x1_gplus_rayleighcurve.pdf',dpi=400)
# plt.show()
...
# ax.set_xlim([0,90])
# plt.tight_layout(pad=0.2,w_pad=1.5,h_pad=1.5)
# plt.savefig('b009_2026feb17figure7_observed_subplots1x1_gminus_rayleighcurve.pdf',dpi=400)
# plt.show()
...
# curve_max = np.max(curve_vec)
# ax.plot(np.degrees(radians_vec),curve_vec*myHist_maxbinheight/curve_max,color='red',linestyle='solid',lw=0.5)
# ax.text(0.92,0.92,'Observed, all\n$\gamma_{est}=$'+str(np.round(kappa,1)),\
#         horizontalalignment='right',verticalalignment='top',bbox=bbox_props,transform=ax.transAxes)
# ax.set_xlabel('Relative inclination (degrees)')
# ax.set_ylabel('Count')
# ax.set_xlim([0,90])
# plt.tight_layout(pad=0.2,w_pad=1.5,h_pad=1.5)
# plt.savefig('b009_2026feb17figure7_observed_subplots1x1_gplusminusnone_rayleighcurve.pdf',dpi=400)
# plt.show()
#%%
# print('')
...
# print('kappa_gplusminusnone = ',np.round(kappa_gplusminusnone,1))
...
# print('kappa_gplus = ',np.round(kappa_gplus,1))
...
# print('kappa_gminus = ',np.round(kappa_gminus,1))
...
qrel_vm17_gminus = qmean_vm17_gminus - qmean_vm17_gplusminusnone
prel_vm17_gminus = pmean_vm17_gminus - pmean_vm17_gplusminusnone
qrel_vm17_gplus = qmean_vm17_gplus - qmean_vm17_gplusminusnone
prel_vm17_gplus = pmean_vm17_gplus - pmean_vm17_gplusminusnone
dot_vm17 = qrel_vm17_gminus*qrel_vm17_gplus + prel_vm17_gminus*prel_vm17_gplus
magnitude_vm17_gminus = np.sqrt(qrel_vm17_gminus**2+prel_vm17_gminus**2)
magnitude_vm17_gplus = np.sqrt(qrel_vm17_gplus**2+prel_vm17_gplus**2)
angledeg_vm17_gminus_gplus = np.degrees(np.arccos(dot_vm17/(magnitude_vm17_gminus*magnitude_vm17_gplus)))
print('angledeg_vm17_gminus_gplus = ',angledeg_vm17_gminus_gplus)
angledeg_vm17_gminus = np.degrees(np.arctan2(prel_vm17_gminus,qrel_vm17_gminus))
angledeg_vm17_gplus = np.degrees(np.arctan2(prel_vm17_gplus,qrel_vm17_gplus))
signed_angledeg_vm17_gminus_gplus = angledeg_vm17_gminus - angledeg_vm17_gplus
print('signed_angledeg_vm17_gminus_gplus = ',signed_angledeg_vm17_gminus_gplus)
#%%
...
# dfdict.to_csv('b009_b_table_plutinos_gplus_gminus_gplusminusnone.csv')
#%%
# plt.scatter(ireldeg_gplusminusnone,energy_gplusminusnone)
# plt.title('ideg_gplusminusnone, energy_gplusminusnone')
# plt.show()
# plt.scatter(ireldeg_gplusminusnone,h_gplusminusnone)
# plt.title('ideg_gplusminusnone, h_gplusminusnone')
# plt.show()
# plt.scatter(ireldeg_gplus,energy_gplus)
# plt.title('ideg_gplus, energy_gplus')
# plt.show()
# plt.scatter(ireldeg_gplus,h_gplus)
# plt.title('ideg_gplus, h_gplus')
# plt.show()
# plt.scatter(ireldeg_gminus,energy_gminus)
# plt.title('ideg_gminus, energy_gminus')
# plt.show()
# plt.scatter(ireldeg_gminus,h_gminus)
# plt.title('ideg_gminus, h_gminus')
# plt.show()
# plt.scatter(ireldeg_gplusminusnone,e_gplusminusnone)
# plt.title('ideg_gplusminusnone, e_gplusminusnone')
# plt.show()
# plt.scatter(ireldeg_gplus,e_gplus)
# plt.title('ideg_gplus, e_gplus')
# plt.show()
# plt.scatter(ireldeg_gminus,e_gminus)
# plt.title('ideg_gminus, e_gminus')
# plt.show()
# plt.hist(ireldeg_gplusminusnone)
# plt.title('ireldeg_gplusminusnone')
# plt.show()
# plt.hist(ireldeg_gplus)
# plt.title('ireldeg_gplus')
# plt.show()
# plt.hist(ireldeg_gminus)
# plt.title('ireldeg_gminus')
# plt.show()
# plt.hist(Wreldeg_gplusminusnone)
# plt.title('Wreldeg_gplusminusnone')
# plt.show()
# plt.hist(Wreldeg_gplus)
# plt.title('Wreldeg_gplus')
# plt.show()
# plt.hist(Wreldeg_gminus)
# plt.title('Wreldeg_gminus')
# plt.show()
# from astropy.stats import rayleightest
# p_value = rayleightest(np.radians(Wreldeg_gplusminusnone))
# print(f"P-value Wreldeg_gplusminusnone: {p_value}")
# p_value = rayleightest(np.radians(Wreldeg_gplus))
# print(f"P-value Wreldeg_gplus: {p_value}")
# p_value = rayleightest(np.radians(Wreldeg_gminus))
# print(f"P-value Wreldeg_gminus: {p_value}")
