...
libration = 'p7q4'
print(libration)
dfind = pd.read_csv('b004_'+libration+'_index.csv')
...
# print(ideg_vmf,Wdeg_vmf,angledegs_vmf)
...
# df_vtvec.to_csv('b012_tnos_'+libration+'_vtvec_all.csv',index=False)
...
# df_vmf.to_csv('b012_tnos_'+libration+'_vmf_all.csv',index=False)
...
# df_fortran.to_csv('b012_tnos_'+libration+'_fortran_all.csv',index=False)
# print('fish')
#%%
# for libration in ['gplus','gminus','gplusminusnone','gall']:
# for libration in ['gall']:
dfind = pd.read_csv('b004_'+libration+'_index.csv')
indices = dfind['index'].to_list()
infile = 'b004_tnos_orbels_jd246e4.csv'
df = pd.read_csv(infile)
...
outfile_siraj = 'b012_tnos_'+libration+'_siraj_logLmat_delta'+str(delta)+'_nq'+str(n_q)+'_np'+str(n_p)+'.csv'
np.savetxt(outfile_siraj,logL_mat_siraj,delimiter=',')
outfile_siraj = 'b012_tnos_'+libration+'_siraj_pvalmat_delta'+str(delta)+'_nq'+str(n_q)+'_np'+str(n_p)+'.csv'
np.savetxt(outfile_siraj,pval_mat_siraj,delimiter=',')
outfile_siraj = 'b012_tnos_'+libration+'_siraj_qmat_delta'+str(delta)+'_nq'+str(n_q)+'_np'+str(n_p)+'.csv'
np.savetxt(outfile_siraj,q_mat_siraj,delimiter=',')
outfile_siraj = 'b012_tnos_'+libration+'_siraj_pmat_delta'+str(delta)+'_nq'+str(n_q)+'_np'+str(n_p)+'.csv'
np.savetxt(outfile_siraj,p_mat_siraj,delimiter=',')
outfile_siraj = 'b012_tnos_'+libration+'_siraj_sigmamat_delta'+str(delta)+'_nq'+str(n_q)+'_np'+str(n_p)+'.csv'
...
df_siraj.to_csv('b012_tnos_'+libration+'_siraj.csv',index=False)