...
maxiter = 10000000
nreps = 3
outfile = trim(adjustl('b020_fortran_mean_planes_vm17_2026feb12_gminus_ijobNNN.txt'))
outfile = trim(adjustl(outfile))
infile_plutinos = trim(adjustl('b020_2026feb12_plutinos_fortran_gminus_2026feb12.csv'))
infile_plutinos = trim(adjustl(infile_plutinos))
infile_vt = trim(adjustl('b020_2026feb12_plutinos_vtvec_gminus_2026feb12.csv'))
