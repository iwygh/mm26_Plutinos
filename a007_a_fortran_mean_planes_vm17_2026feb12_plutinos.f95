...
maxiter = 10000000
nreps = 3
outfile = trim(adjustl('b007_fortran_mean_planes_vm17_2026feb12_plutinos_ijobNNN.txt'))
outfile = trim(adjustl(outfile))
infile_plutinos = trim(adjustl('b006_2026feb12_plutinos_fortran_gplusminusnone_2026feb12.csv'))
infile_plutinos = trim(adjustl(infile_plutinos))
infile_vt = trim(adjustl('b006_2026feb12_plutinos_vtvec_gplusminusnone_2026feb12.csv'))
