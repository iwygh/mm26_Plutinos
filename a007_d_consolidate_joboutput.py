...
for ijob in range(njobs):
    infile = 'b007_fortran_mean_planes_vm17_2026feb12_plutinos_ijob'+str(ijob+1)+\
...
outfile = 'b007_d_consolidated_mean_planes_vm17_2026feb12_plutinos_gplusminusnone_njobs'+\
